...
<nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    <a class="navbar-brand logo-text page-scroll" href="/home">NL-TRAVEL</a>
...
<!--                        --><?php
                        ...
                        <?php for($i = 0; $i < count($accommodations); $i++) : ?>
                            <?php if($accommodations[$i]["id"] === $_GET['id'] ) continue?>
            ...
            <div class="col-lg-6">
                <div class="text-container">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li><i class="fas fa-envelope"></i><a href="mailto:office@aria.com">office@dzonzi.com</a></li>
                    </ul>
